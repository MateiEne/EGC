...
Enemy::Enemy(const char* name, glm::vec2 position) : Object_2D(name, position) {
}
...
void Enemy::InitVertices()
{
	vertices.insert(vertices.end(), {
		// position, color, norm
		VertexFormat(glm::vec3(-1, 0.4f, 0), glm::vec3(0, 1, 1), glm::vec3(0, 1, 0)), // A - 0
		VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0, 1, 0)), // B - 1
		VertexFormat(glm::vec3(1, 0.4f, 0), glm::vec3(0, 1, 1), glm::vec3(0, 1, 0)), // C - 2
		VertexFormat(glm::vec3(1, -0.4f, 0), glm::vec3(0, 1, 1), glm::vec3(0, 1, 0)), // D - 3
		VertexFormat(glm::vec3(0, -1, 0), glm::vec3(0, 1, 1), glm::vec3(0, 1, 0)), // E - 4
		VertexFormat(glm::vec3(-1, -0.4f, 0), glm::vec3(0, 1, 1), glm::vec3(0, 1, 0)), // F - 5
